		...
		<Section className="w-full border-2 border-gray-300 rounded-md max-h-[600px] flex flex-col">
			...
			<div className="flex-1 overflow-hidden">
				<div className="overflow-x-auto overflow-y-auto h-full scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 rounded-md">
					<TableUI className="mx-auto w-full table-fixed min-w-[800px]">
						<TableHeader className="mb-0 sticky top-0 z-10 bg-white dark:bg-gray-700">
								...
								<>
									{data?.data?.map((item) => (
										...
										>
											...
											<TableCell className="py-2.5 flex font-medium text-center dark:text-gray-300">
												<FaEdit
													onClick={() => {
														if (onEditProduct) {
															onEditProduct(item);
													...
													className="text-blue-500 cursor-pointer hover:text-blue-700 mx-auto h-5 w-5"
												/>
												<MdDelete
													onClick={() => {
														setOpenConfirmDelete(
													...
													className="text-red-500 cursor-pointer hover:text-red-700 mx-auto h-5 w-5"
												/>
											</TableCell>
										</TableRow>
									))}
