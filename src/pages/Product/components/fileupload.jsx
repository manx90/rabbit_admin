...
export default function FileUpload({ resetKey, name, registerName, maxFiles }) {
  const maxSizeMB = 5;
      ...
      {files.length === 0 && (
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center px-4 py-3 text-center">
            ...
            <p className="mb-1.5 text-sm font-medium">Drop your {name} here</p>
        ...
        <div className="grid grid-cols-1">
          ...
          {files.length > 0 && (
            <div className="flex items-center justify-between gap-2 mt-2">
              ...
              >
                {maxFiles > 1 ? "Remove all files" : "Remove file"}
              </Button>
