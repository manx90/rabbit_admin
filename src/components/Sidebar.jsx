    ...
    >
      ...
      <nav className="flex flex-col gap-4 w-full px-4 md:px-10 py-5 border-b border-[#363030] flex-grow overflow-y-auto">
        ...
        <NavLink
          ...
          icon={<Package />}
          label="Order"
          isActive={window.location.pathname === "/order"}
        />
        <NavLink
          to="/advertisements"
          open={open}
          ...
          icon={<Megaphone />}
          label="Advertising"
          isActive={window.location.pathname === "/advertisements"}
        />
      </nav>
    </div>
  );
