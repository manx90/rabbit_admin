...
export class Category {
  ...
  static updateSubCategory = (SubCategoryId, CategoryId, formData) =>
    axiosClient.put(
  ...
  static updateState = (id) =>
    axiosClient.put(`${mainDirection}/update-state/${id}`);
  static updateStateSub = (id) =>
    axiosClient.put(`${mainDirection}/update-state-subcategory/${id}`);
}
